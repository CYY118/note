...
想要成为真正的“互联网Java[全栈](https://so.csdn.net/so/search?q=全栈&spm=1001.2101.3001.7020)工程师”还有很长的一段路要走，其中前端是绕不开的一门必修课。本阶段课程的主要目的就是带领Java后台程序员认识前端、了解前端、掌握前端，为实现成为“互联网Java全栈工程师”再向前迈进一步。
...
Vue 的核心库只关注视图层，方便与[第三方库](https://so.csdn.net/so/search?q=第三方库&spm=1001.2101.3001.7020)或既有项目整合。

HTML + CSS + JS : 视图 ： `给用户看，刷新后台给的数据`

网络通信 ： [axios](https://so.csdn.net/so/search?q=axios&spm=1001.2101.3001.7020)
